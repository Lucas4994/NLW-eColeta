...
const CreatePoint: React.FC = () => {
    ...
    const [selecetedItems, setSelectedItem] = useState<number[]>([]);
    ...
    function handleSelectetItem(itemId: number) {
        ...
        if(alredySelected >= 0) {
            ...
            setSelectedItem([...selecetedItems, itemId])
        }
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            <label htmlFor="city">Estado (City)</label>
                            <select 
                                name="city" 
                                id="city"
                                value={selectedCity}
                ...
                <fieldset>
                    ...
                    <ul className="items-grid">
                        {items.map(item => (
                            <li 
                                onClick={() => handleSelectetItem(item.id)} 
                                key ={item.id}
